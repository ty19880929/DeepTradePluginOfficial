"""Unit tests for Step 0 trade-date resolution after the v0.10.0 rewrite.
...
from volume_anomaly.data import fetch_latest_trade_date, resolve_trade_date
...
class TestResolveTradeDate:
    ...
    def test_wrong_local_clock_does_not_affect_T(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr("volume_anomaly.data.datetime", _FakeDt)
