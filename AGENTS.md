...
- `limit_up_board/`, `accumulation_probe_washout/`, and `checkmate/`: plugin roots.
...
- `python -m pytest accumulation_probe_washout`: runs the `accumulation-probe-washout` tests.
